...
iconv -f utf-8 -t utf-8//IGNORE <webissues.xml |java -jar ~/lib/saxon9he.jar -xsl:wi2.xslt -s:-
...
do
	echo $REPLY
	echo "<h1>$REPLY</h1><img src=\"$REPLY.png\"/><br/>">>out/index.html
	(head -1 burndown.dat;grep "$REPLY," burndown.dat)|head -30 >sprint.dat
